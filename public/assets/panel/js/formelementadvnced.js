(function($) {
	"use strict";
		...
		//MULTI
		window.asd = $('.SlectBox').SumoSelect({ csvDispCount: 3, selectAll:true, captionFormatAllSelected: "باشه اوکی پس همه چی" });
        window.Search = $('.search-box').SumoSelect({ csvDispCount: 3, search: true, searchText:'اینجا وارد کنید' });
		...
		$('.search_test').SumoSelect({search: true, searchText: 'اینجا وارد کنید'});
		...
		multi(select, {
			non_selected_header: 'آیتم ها',
			selected_header: 'آیتم محبوب'
		});
