(function ($) {
    ...
    if ($('.slide-item.active').attr('href') !== 'cards.html' && $('.slide-item.active').attr('href') !== 'loaders.html') {
    ...
    // DARK THEME START
    $(document).on("change", '#font-changer-en', function () {
        let font = $(this).val();
        console.log('1111')
        $('head #fonts').attr('href', '../assets/fonts/styles-en-num/' + font + '.css')
    });
    $(document).on("change", '#font-changer', function () {
        let font = $(this).val();
        console.log('2222')
        $('head #fonts').attr('href', '../assets/fonts/styles-fa-num/' + font + '.css')
    });
