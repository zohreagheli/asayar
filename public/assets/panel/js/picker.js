    ...
    button.addEventListener('click', () => {
        ...
        pickr = new Pickr(Object.assign({
            ...
            i18n: {
                ...
                'btn:toggle': 'گفتگوی انتخابگر رنگ را تغییر دهید',
                'btn:swatch': 'تعوض رنگ',
                ...
                'aria:input': 'ورودی رنگ',
                'aria:palette': 'ناحیه انتخاب رنگ',
                'aria:hue': 'نوار لغزنده انتخاب رنگ',
                'aria:opacity': 'نوار لغزنده انتخاب'
            }
        }, config));
