...
var FullCalendar = function(e) {
	...
	var Lr = function() {
		...
		Wr = {
			...
			allDayText: "طول روز",
			moreLinkText: "بیشتر",
			noEventsText: "رخدادی برای نمایش نیست"
		},
		Vr = r(r({}, Wr), {
			buttonHints: {
				prev: "قبلی $0",
				next: "بعدی $0",
				today: function(e, t) {
					return "روز" === t ? "امروز" : "این " + e
				}
			},
			viewHint: "$0 نمایش",
			navLinkHint: "رفتن به $0",
			moreLinkHint: function(e) {
				return "نمایش " + e + " رخداد بیشتر" + (1 === e ? "" : "s")
			}
		});

	function Fr(e) {
		for (var t = e.length > 0 ? e[0].code : "fa", n = Ur.concat(e), r = {
				en: Vr
