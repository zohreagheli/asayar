...
(function ($) {
    ...
    $.fn.FancyFileUpload.defaults = {
        ...
        'fileupload': {},
        'langmap': {
            'There is a file upload still in progress.  Leaving the page will cancel the upload.\n\nAre you sure you want to leave this page?': 'یک فایل آپلود هنوز در حال انجام است. خروج از صفحه باعث لغو آپلود می شود. آیا مطمئن هستید که می خواهید این صفحه را ترک کنید؟',
            'Starting upload...': 'شروع آپلود ...',
            'Cancel upload and remove from list': 'لغو آپلود و حذف از لیست',
            'This file is currently being uploaded.\n\nStop the upload and remove the file from the list?': 'این فایل در حال حاضر در حال آپلود است. بارگذاری را متوقف کنید و فایل را از لیست حذف کنید؟',
            'Preview': 'پیشنمایش',
            'No preview available': 'پیشنمایشی وجود ندارد',
            'Invalid file extension.': 'نوع فایل نامعتبر است.',
            'File is too large.  Maximum file size is {0}.': 'فایل بسیار بزرگ است. جداکثر حجم فایل {0}',
            'Start uploading': 'شروع آپلود',
            'Remove from list': 'حذف از لیست',
            '{0} of {1} | {2}%': '{0} از {1} | {2}%',
            '{0} | Network error, retrying in a moment...': '{0} | خطای شبکه، در حال تلاش مجدد ...',
            'The upload was cancelled.': '',
            'The upload failed.  {0} ({1})': 'آپلود شکست خورد  {0} ({1})',
            'The server indicated that the upload was not successful.  No additional information available.': 'سرور نشان داد که آپلود موفقیت آمیز نبود. اطلاعات اضافی در دسترس نیست.',
            'Upload completed': 'آپلود تکمیل شد',
            'Browse, drag-and-drop, or paste files to upload': 'برای آپلود فایل‌ها را در مرورگر بکشید و رها کنید یا جای‌گذاری کنید',
        }
    };
