document.addEventListener('DOMContentLoaded', function() {
    (function () {
        ...
        var toggleSidebar = function () {
            ...
            if (w.outerWidth() <= 1024) {
                ...
                $("body").removeClass("sidebar-show"); // این خط را هم اضافه کنید
            }
        }
        toggleSidebar();
    ...
    // اضافه کردن event listeners برای slide-left و slide-right
    ...
    if (slideRight) {
        ...
        console.warn('slideRight element not found');
    }

    // اضافه کردن event listener برای main-content با بررسی وجود المنت
...
// توابع utility خارج از DOMContentLoaded
function responsive() {
...
// فقط یک تعریف از تابع slideClick
function slideClick() {
